    ...
    appBar: AppBar(
      ...
      actions: [IconButton(onPressed: (){}, icon: Icon(Icons.more_vert))],
        ...
        children: [
          ...
          Center(
            child: Text('Andre Arthur', style:TextStyle(fontSize:19,fontWeight: FontWeight.w800, color: Colors.black),
        ),
          ),
          Center(
      ...
      Container(
        ...
        subtitle: Text('+233242221300', style:TextStyle(fontSize:16,fontWeight: FontWeight.w500, color: Colors.grey),
        ),
        ...
        subtitle: Text('andrearthur@gmail.com', style:TextStyle(fontSize:16,fontWeight: FontWeight.w500, color: Colors.grey),
        ),
         trailing: Row(mainAxisSize: MainAxisSize.min,
        ...
        subtitle: Text('BCOM', style:TextStyle(fontSize:16,fontWeight: FontWeight.w500, color: Colors.grey),
            ), 
          ),
          ]
        ),
